package com.sriyaan.sqldatabasepathapp;
...
import com.sriyaan.sqldatabasepathapp.adapter.ListProductAdapter;
import com.sriyaan.sqldatabasepathapp.database.DatabaseHelper;
import com.sriyaan.sqldatabasepathapp.model.Product;
...
public class MainActivity extends Activity {
    ...
    private boolean copyDatabase(Context context) {
        try {
            ...
            String dbPath = "/storage/emulated/0/IMudra/sample.db";
            FileInputStream inputStream = new FileInputStream(dbPath);

            //from assets dir data take
